...
from odoo.addons.sdm_account_reports.models.account_report import AccountReportFileDownloadException
...
class AccountReportController(http.Controller):
    ...
    @http.route('/sdm_account_reports', type='http', auth='user', methods=['POST'], csrf=False)
