...
from odoo.addons.sdm_account_reports.tests.common import TestAccountReportsCommon
...
class TestDeferredReports(TestAccountReportsCommon, HttpCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.deferred_expense_report = cls.env.ref('sdm_account_reports.deferred_expense_report')
        cls.deferred_revenue_report = cls.env.ref('sdm_account_reports.deferred_revenue_report')
