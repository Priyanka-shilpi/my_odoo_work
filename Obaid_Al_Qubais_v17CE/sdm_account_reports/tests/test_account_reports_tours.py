...
class TestAccountReportsTours(AccountTestInvoicingHttpCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('sdm_account_reports.balance_sheet')
        ...
        # Line ids
        line_id_ta = cls.report._get_generic_line_id('account.report.line', cls.env.ref('sdm_account_reports.account_financial_report_total_assets0').id)
        line_id_ca = cls.report._get_generic_line_id('account.report.line', cls.env.ref('sdm_account_reports.account_financial_report_current_assets_view0').id, parent_line_id=line_id_ta)
        line_id_ba = cls.report._get_generic_line_id('account.report.line', cls.env.ref('sdm_account_reports.account_financial_report_bank_view0').id, parent_line_id=line_id_ca)
        ...
        line_id_cas = cls.report._get_generic_line_id('account.report.line', cls.env.ref('sdm_account_reports.account_financial_report_current_assets0').id, parent_line_id=line_id_ca)
    ...
    def test_sdm_account_reports_tours(self):
        self.start_tour("/web", 'sdm_account_reports', login=self.env.user.login)
