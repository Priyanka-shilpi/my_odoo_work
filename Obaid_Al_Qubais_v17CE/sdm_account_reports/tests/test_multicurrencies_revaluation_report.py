...
class TestMultiCurrenciesRevaluationReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('sdm_account_reports.multicurrency_revaluation_report')
    ...
    def test_exclude_account_for_adjustment_entry(self):
        ...
        oldest_line_id = self.report._get_generic_line_id('account.report.line', self.env.ref('sdm_account_reports.multicurrency_revaluation_to_adjust').id)
