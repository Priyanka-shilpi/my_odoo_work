...
class TestAgedReceivableReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('sdm_account_reports.aged_receivable_report')
        cls.parent_line_id = cls._get_basic_line_dict_id_from_report_line_ref("sdm_account_reports.aged_receivable_line")
