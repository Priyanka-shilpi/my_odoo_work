...
class TestGeneralLedgerReport(TestAccountReportsCommon, odoo.tests.HttpCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('sdm_account_reports.general_ledger_report')
    ...
    def test_tour_sdm_account_reports_search(self):
        ...
        self.start_tour("/web", 'sdm_account_reports_search', login=self.env.user.login)
