...
from odoo.addons.sdm_account_reports.tests.account_sales_report_common import AccountSalesReportCommon
...
class AccountSalesReportTest(AccountSalesReportCommon):
    ...
    def test_ec_sales_report(self):
        ...
        report = self.env.ref('sdm_account_reports.generic_ec_sales_report')
