...
class AgedPartnerBalanceCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            ...
            'components': {
                'AccountReportLineName': 'sdm_account_reports.AgedPartnerBalanceLineName',
            },
        }
...
class AgedPayableCustomHandler(models.AbstractModel):
    ...
    def _custom_unfold_all_batch_data_generator(self, report, options, lines_to_expand_by_function):
        if self.env.ref('sdm_account_reports.aged_payable_line').groupby.replace(' ', '') == 'partner_id,id':
...
class AgedReceivableCustomHandler(models.AbstractModel):
    ...
    def _custom_unfold_all_batch_data_generator(self, report, options, lines_to_expand_by_function):
        ...
        if self.env.ref('sdm_account_reports.aged_receivable_line').groupby.replace(' ', '') == 'partner_id,id':
