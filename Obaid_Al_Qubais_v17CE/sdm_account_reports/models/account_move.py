...
class AccountMove(models.Model):
    ...
    def action_open_tax_report(self):
        action = self.env["ir.actions.actions"]._for_xml_id("sdm_account_reports.action_account_report_gt")
    ...
    def _close_tax_period(self, report, options):
        ...
        tax_closing_activity_type = self.env.ref('sdm_account_reports.tax_closing_activity_type')
