...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            ...
            'components': {
                'AccountReportLine': 'sdm_account_reports.JournalReportLine',
            },
            'templates': {
                'AccountReportFilters': 'sdm_account_reports.JournalReportFilters',
                'AccountReportHeader': 'sdm_account_reports.JournalReportHeader',
                'AccountReportLineName': 'sdm_account_reports.JournalReportLineName',
            },
            'pdf_export': {
                'pdf_export_main_table_header': 'sdm_account_reports.journal_report_pdf_export_main_table_header',
                'pdf_export_filters': 'sdm_account_reports.journal_report_pdf_export_filters',
                'pdf_export_main_table_body': 'sdm_account_reports.journal_report_pdf_export_main_table_body',
            },
        }
    ...
    def _query_journal(self, options):
        params = []
        queries = []
        report = self.env.ref('sdm_account_reports.journal_report')
                ...
                if treated_amls_count == 0:
                    ...
                    if self.env.user.has_group('account.group_account_manager'):
                        action = {
                            ...
                            "res_id" : report.id,
                            "views": [[self.env.ref("sdm_account_reports.account_report_form").id, "form"]],
                        }
