...
import { AccountReport } from "@sdm_account_reports/components/account_report/account_report";
import { AccountReportLineName } from "@sdm_account_reports/components/account_report/line_name/line_name";
import { ExpectedDateDialog } from "@sdm_account_reports/components/aged_partner_balance/dialog/expected_date_dialog";
...
export class AgedPartnerBalanceLineName extends AccountReportLineName {
    static template = "sdm_account_reports.AgedPartnerBalanceLineName";
