...
import { AccountReportController } from "@sdm_account_reports/components/account_report/controller";
import { AccountReportButtonsBar } from "@sdm_account_reports/components/account_report/buttons_bar/buttons_bar";
import { AccountReportEllipsis } from "@sdm_account_reports/components/account_report/ellipsis/ellipsis";
import { AccountReportFilters } from "@sdm_account_reports/components/account_report/filters/filters";
import { AccountReportHeader } from "@sdm_account_reports/components/account_report/header/header";
import { AccountReportLine } from "@sdm_account_reports/components/account_report/line/line";
import { AccountReportLineCell } from "@sdm_account_reports/components/account_report/line_cell/line_cell";
import { AccountReportLineName } from "@sdm_account_reports/components/account_report/line_name/line_name";
import { AccountReportSearchBar } from "@sdm_account_reports/components/account_report/search_bar/search_bar";

export class AccountReport extends Component {
    static template = "sdm_account_reports.AccountReport";
    static props = {
        action: Object,
    ...
    static registerCustomComponent(customComponent) {
        registry.category("sdm_account_reports_custom_components").add(customComponent.template, customComponent);
    }
    ...
    getComponent(name) {
        ...
        if (customComponents && customComponents[name])
            return registry.category("sdm_account_reports_custom_components").get(customComponents[name]);
    ...
    getTemplate(name) {
        ...
        return `sdm_account_reports.${ name }Customizable`;
    }
