...
import { AccountReportFootnoteDialog } from "@sdm_account_reports/components/account_report/footnote/dialog/footnote_dialog";
...
export class AccountReportController {
    ...
    async loadReport(reportId, preloading=false) {
        const busEventPayload = { data: {id: `_sdm_account_reports_load_report_${reportId}`, params: {}}, settings: {} };
        if (!preloading)
    ...
    async loadReportOptions(reportId, preloading=false, ignore_session=false) {
        ...
        if (!this.reportOptionsMap[cacheKey]) {
            ...
            const busEventPayload = { data: {id: `_sdm_account_reports_load_report_options_${reportId}`, params: {}}, settings: {} };
            if (preloading)
