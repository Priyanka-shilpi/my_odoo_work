...
import { AccountReportEllipsisPopover } from "@sdm_account_reports/components/account_report/ellipsis/popover/ellipsis_popover";

export class AccountReportEllipsis extends Component {
    static template = "sdm_account_reports.AccountReportEllipsis";
    static props = {
