...
import { AccountReportDebugPopover } from "@sdm_account_reports/components/account_report/line/popover/debug_popover";

export class AccountReportLine extends Component {
    static template = "sdm_account_reports.AccountReportLine";
    static props = {
        lineIndex: Number,
        line: Object,
    };
