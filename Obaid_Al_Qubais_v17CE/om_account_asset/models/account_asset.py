...
class AccountAssetCategory(models.Model):
    ...
    is_it_asset = fields.Boolean(string='Is IT Asset ?')
    is_equipment_asset = fields.Boolean(string='Is Equipment Asset ?')
    is_camp_asset = fields.Boolean(string='Is Camp Asset ?')
