# -*- coding: utf-8 -*-
from odoo.addons.sdm_accounting.tests.test_bank_rec_widget_common import TestBankRecWidgetCommon
...
class TestBankRecWidget(TestBankRecWidgetCommon, HttpCase):
    ...
    def test_tour_bank_rec_widget(self):
        self.start_tour('/web', 'sdm_accounting_bank_rec_widget', login=self.env.user.login)
    ...
    def test_tour_bank_rec_widget_ui(self):
        ...
        self.start_tour('/web?debug=assets', 'sdm_accounting_bank_rec_widget_ui', timeout=100, login=self.env.user.login)

    def test_tour_bank_rec_widget_rainbowman_reset(self):
        self.start_tour('/web?debug=assets', 'sdm_accounting_bank_rec_widget_rainbowman_reset', login=self.env.user.login)

    def test_tour_bank_rec_widget_statements(self):
        self.start_tour('/web?debug=assets', 'sdm_accounting_bank_rec_widget_statements', login=self.env.user.login)
