...
def _sdm_accounting_post_init(env):
    ...
    for company in env['res.company'].search([('chart_template', '!=', False)]):
        ...
        ChartTemplate._load_data({
            'res.company': ChartTemplate._get_sdm_accounting_res_company(company.chart_template),
        })
...
def uninstall_hook(env):
    ...
    # make the sdm_accounting features disappear (magic)
