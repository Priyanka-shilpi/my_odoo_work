...
registry.category("web_tour.tours").add('sdm_accounting_bank_rec_widget_rainbowman_reset',
    {
        test: true,
        url: '/web',
        steps: () => [
        stepUtils.showAppsMenuItem(),
        ...stepUtils.goToAppSteps('sdm_accounting.menu_accounting', "Open the accounting module"),
        ...
        ...stepUtils.goToAppSteps(
            'sdm_accounting.menu_accounting',
