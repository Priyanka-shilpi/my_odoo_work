/** @odoo-module **/
    ...
    patch(registry.category("web_tour.tours").get("account_tour"), {
        steps() {
            ...
            originalSteps.splice(0, 3,
                ...stepUtils
                    .goToAppSteps("sdm_accounting.menu_accounting", _t("Go to invoicing"))
    ...
    registry.category("web_tour.tours").add('sdm_accounting_tour', {
            ...
            sequence: 50,
            steps: () => [
            ...stepUtils.goToAppSteps('sdm_accounting.menu_accounting', _t('Let’s automate your bills, bank transactions and accounting processes.')),
